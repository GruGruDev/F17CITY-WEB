...
function XM_Dropdown(t) {
  var c,
    g = {
      ...
      animation: {
        ...
        ease: "ease-in-out",
        zIndex: 9999,
        translateOffset: { horizontal: 40, vertical: 40 },
      },
      absolute: !1,
    ...
    r = function () {
      if (g.controlToggle) {
        ...
        if (!t.length)
          throw new Error("".concat(g.container, " not found in the DOM"));
        var n = !0,
          r = !1,
          o = void 0;
        try {
          for (
            var e, i = t[Symbol.iterator]();
            !(n = (e = i.next()).done);
            n = !0
          ) {
            var a = e.value,
        ...
        if (!c.length)
          throw new Error("".concat(g.trigger, " not found in the DOM"));
        var f = !0,
          s = !1,
          u = void 0;
        try {
          for (
            var y, v = c[Symbol.iterator]();
            !(f = (y = v.next()).done);
            f = !0
          ) {
            var d = y.value,
            ...
            if (!p)
              throw new Error(
                ""
                  .concat(g.container, " not found as sibling of ")
                  .concat(g.trigger)
              );
            var m = {};
            (m.parent = p.parentElement),
              (m.trigger = d),
              (m.container = p),
              h.push(m);
          }
    ...
    a = function (t) {
      for (var n in ((t.parent.style.position = g.absolute
        ? "absolute"
        : "relative"),
      S(t.container, { position: "absolute", zIndex: g.animation.zIndex }),
      g.offset))
        t.container.style[n] = "".concat(g.offset[n], "px");
    },
    e = function () {
      var t = !0,
        n = !1,
    ...
    l = function (t) {
      ("translate-top" !== g.animation.type &&
        "translate-bottom" !== g.animation.type) ||
      ...
      "static" === g.animation.type
        ...
        ? S(t.container, {
            ...
            transform: "translate(0, -".concat(
              g.animation.translateOffset.vertical,
              "px)"
            ),
          })
        : "translate-bottom" === g.animation.type &&
  ...
  return (
    (function t(n, r) {
      var o;
      for (var e in r)
        "object" !== _typeof(r[e]) || r[e] instanceof Date
          ? r[e] instanceof Date
            ? (n[e] = new Date(r[e].getTime()))
            : (n[e] = r[e])
          : ((o = r[e] instanceof Array ? [] : {}),
            void 0 === n[e] && (n[e] = o),
            t(n[e], r[e]));
    })(g, t),
    r(),
...
function XM_Hexagon(t) {
  var p = {
    ...
    e = function () {
      t.scale &&
        ...
        (p.scale.stop = void 0 !== t.scale.stop ? p.scale.stop : p.scale.end)),
      ...
      try {
        for (
          ...
          if (p.gradient) {
            ...
            a.addColorStop(0, p.gradient.colors[0]),
              a.addColorStop(1, p.gradient.colors[1]),
              (o.ctx.strokeStyle = a),
              (o.ctx.fillStyle = a);
          } else
            (o.ctx.strokeStyle = p.lineColor), (o.ctx.fillStyle = p.lineColor);
  ...
  function d(t) {
    t.animation.currentProgress < p.stopPoint &&
      (t.animation.easing
        ? ((t.animation.currentProgress +=
            0.06 * (p.stopPoint - t.animation.currentProgress)),
          t.animation.currentProgress >= p.stopPoint - 1 &&
            ((t.animation.currentProgress = p.stopPoint),
            (t.finishedDrawing = !0)))
        : ((t.animation.currentProgress += t.animation.step),
          t.animation.currentProgress >= p.stopPoint &&
            ((t.animation.currentProgress = p.stopPoint),
            (t.finishedDrawing = !0)))),
      ...
      if ((n.ctx.clearRect(0, 0, p.width, p.height), 0 !== i)) {
        if ((n.ctx.beginPath(), p.roundedCorners)) {
          var e = p.fill || p.clip ? 0 : p.lineWidth / 2,
            ...
            o = (function (t) {
              return (
                ((p.height - v.sideWidth) / p.width) * t +
                (v.sideWidth - p.height) / 2
              );
            })(p.width - r);
          if (p.clip || p.fill)
            n.ctx.moveTo(p.width / 2 - r, p.roundedCornerRadius + e),
              n.ctx.quadraticCurveTo(
                ...
                0 + e,
                p.width / 2 + r,
                p.roundedCornerRadius + e
              ),
              n.ctx.lineTo(p.width - e - r, o),
              n.ctx.quadraticCurveTo(
                p.width - e,
                (p.height - v.sideWidth) / 2,
                p.width - e,
                (p.height - v.sideWidth) / 2 + r
              ),
              n.ctx.lineTo(
                p.width - e,
                p.height - (p.height - v.sideWidth) / 2 - r
              ),
              n.ctx.quadraticCurveTo(
                p.width - e,
                p.height - (p.height - v.sideWidth) / 2,
                p.width - e - r,
                p.height - o
              ),
              n.ctx.lineTo(
                p.width / 2 + r,
                p.height - e - p.roundedCornerRadius
              ),
              n.ctx.quadraticCurveTo(
                p.width / 2,
                p.height - e,
            ...
            for (;;) {
              ...
              if (
                ...
                break;
              if (
                ((f = { x: p.width - e, y: (p.height - v.sideWidth) / 2 + r }),
                (x = {
                  x: p.width - e,
              ...
              if (
                ...
                (x = { x: 0 + e, y: (p.height - v.sideWidth) / 2 + r }),
                (w = T(f, x, g)),
                n.ctx.lineTo(w.x, w.y),
                (g -= w.distance) <= 0)
              )
              ...
              if (
                ((f = { x: 0 + e + r, y: o }),
                (x = { x: p.width / 2 - r, y: p.roundedCornerRadius + e }),
                (w = T(f, x, g)),
                n.ctx.lineTo(w.x, w.y),
                (g -= w.distance) <= 0)
              )
              ...
              y.addEventListener("load", function () {
                var t = Math.max(p.width, p.height),
                  i =
                    ...
                    p.width < p.height ? (p.width - p.height) / 2 : 0),
  ...
  (this.render = function (t) {
    (t =
      ((t =
        (t = t > p.scale.end ? p.scale.end : t) < p.scale.start
          ? p.scale.start
          : t) /
        p.scale.end) *
      p.width),
...
function XM_Popup(t) {
  function n() {
    "static" === s.overlay.animation.type
  ...
  var s = {
    ...
    o = function () {
      (r.overlay.style.width = "100%"),
        ...
        (r.overlay.style.backgroundColor = "rgba("
          .concat(s.overlay.color, ", ")
          .concat(s.overlay.opacity, ")")),
    ...
    i = function () {
      "fade" === s.overlay.animation.type &&
        (r.overlay.style.transition = "opacity "
          .concat(s.overlay.animation.speed, "s ")
          .concat(s.overlay.animation.ease, ", \n      visibility ")
          .concat(s.overlay.animation.speed, "s ")
          .concat(s.overlay.animation.ease));
    },
    a = function () {
    ...
    l = function () {
      if (
        ((r.popupContainer = document.querySelector(s.container)),
        !r.popupContainer)
      )
        throw new Error("Couldn't find ".concat(s.container, " in the DOM"));
      y();
    },
    y = function () {
      (r.popupContainer.style.position = s.sticky ? "fixed" : "absolute"),
        (r.popupContainer.style.left = "50%"),
    ...
    c = function () {
      ...
      "center" === s.align
        ...
        : "bottom" === s.align &&
          (r.popupContainer.style.top = "".concat(e, "px")),
        s.sticky ||
          (r.visible
            ? (r.popupContainer.style.top = "".concat(
                s.offset.top + window.scrollY,
        ...
        (r.popupContainer.style.marginLeft = "-".concat(
          r.popupContainer.offsetWidth / 2,
          "px"
        ));
    },
    u = function () {
    ...
    m = function () {
      ...
      if (!t.length)
        throw new Error("Couldn't find ".concat(s.trigger, " in the DOM"));
      var n = !0,
        e = !1,
        o = void 0;
      try {
  ...
  return (
    (function t(n, e) {
      var o;
      for (var i in e)
        "object" !== _typeof(e[i]) || e[i] instanceof Date
          ? e[i] instanceof Date
            ? (n[i] = new Date(e[i].getTime()))
            : (n[i] = e[i])
          : ((o = e[i] instanceof Array ? [] : {}),
            void 0 === n[i] && (n[i] = o),
            t(n[i], e[i]));
    })(s, t),
    e(),
...
function XM_ProgressBar(h) {
  ...
  var p = {
    ...
    w = function (e) {
      void 0 === e && (((e = {}).width = p.width), (e.height = p.height)),
        (o.width = e.width),
        (o.height = e.height),
    ...
    T = function () {
      p.linkText &&
        (p.innerLink &&
          ((p.linkElContainer = l.container.parentElement.querySelector(
            p.linkToContainer
          )),
          p.linkElContainer ||
  ...
  var E = function (e) {
      ...
      if (
        (r.beginPath(),
        "butt" === p.lineCap &&
          (r.moveTo(0, p.height / 2), r.lineTo(t, p.height / 2), r.stroke()),
        "round" === p.lineCap)
      ) {
        var n = r.lineWidth / 2,
          i = t - n;
        p.reverse
          ? (r.moveTo(p.width - n, p.height / 2),
            p.width - t <= n
              ? r.lineTo(n, p.height / 2)
              : r.lineTo(p.width - t, p.height / 2))
          : (r.moveTo(n, p.height / 2),
            i < n ? r.lineTo(n, p.height / 2) : r.lineTo(i, p.height / 2)),
          r.stroke(),
          p.buttEnd &&
            ((r.lineCap = "butt"),
            p.reverse
              ? (r.moveTo(p.width - t, p.height / 2),
                r.lineTo(p.width - t - n, p.height / 2))
              : (r.moveTo(i, p.height / 2), r.lineTo(t, p.height / 2)),
            r.stroke(),
            (r.lineCap = "round"));
      }
      p.barText && s(t),
  ...
  !(function () {
    ...
    if (
      ...
      h.scale &&
        ...
        (p.scale.stop =
          p.scale.stop < p.scale.start ? p.scale.start : p.scale.stop),
        (p.scale.stop = void 0 !== h.scale.stop ? p.scale.stop : p.scale.end)),
      ...
      if (void 0 !== p.split.parts)
        for (
          var t = (p.width - p.split.gap * (p.split.parts - 1)) / p.split.parts,
            n = -p.split.gap,
            i = 0;
          i < p.split.parts;
          i++
        ...
        try {
          for (
            var s, c = p.split.partItems[Symbol.iterator]();
            !(r = (s = c.next()).done);
            r = !0
          ) {
            var d = s.value;
...
function XM_Tab(n) {
  var a = {
      ...
      elements: "",
      startOpen: 1,
      animation: { type: "static", speed: 0.6, easing: "ease-in-out" },
    ...
    i = function () {
      return (
        (s.triggers = document.querySelectorAll(a.triggers)), s.triggers.length
      );
    },
    r = function () {
      return (
        (s.elements = document.querySelectorAll(a.elements)), s.elements.length
      );
    },
    o = function () {
      for (
    ...
    y = function (t) {
      t.style.transition = "all "
        .concat(a.animation.speed, "s ")
        .concat(a.animation.easing);
    },
    m = function (t) {
    ...
    g = function () {
      ...
      try {
        for (
          var i, r = s.elements[Symbol.iterator]();
          !(t = (i = r.next()).done);
          t = !0
        ) {
          var o = i.value;
    ...
    p = function (t) {
      "slide-in-right" === a.animation.type &&
        S(t, { position: "absolute", left: "0", zIndex: 1 });
    },
    b = function (t) {
      "static" === a.animation.type
        ? S(t, { display: "block" })
        : "slide-in-right" === s.animationType &&
          S(t, {
            position: "static",
            transform: "translate(0, 0)",
            opacity: 1,
      ...
      if ("static" === a.animation.type) S(t, { display: "block" });
        ...
        for (
          ...
          !(n =
            ...
            s.elements[s.elements.length - 1]).classList.contains(
            a.elements.substring(1)
          );
  ...
  return (
    (function () {
      if ((T(a, n), r() && i())) {
        (s.animationType = a.animation.type),
          window.innerWidth < 1366 && (a.animation.type = "static"),
          l(),
          u(a.startOpen - 1),
          g(),
          o();
        var t = e();
        window.addEventListener("resize", function () {
          window.innerWidth < 1366 && "desktop" === t
            ? (v(), (a.animation.type = "static"), d(), g())
            : 1366 <= window.innerWidth &&
              "mobile" === t &&
              (v(), (a.animation.type = s.animationType), d(), g()),
            (t = e());
        });
      }
    })(),
...
function XM_Tooltip(t) {
  var W = {
    ...
    o = function (t, i, e) {
      ...
      if (!t)
        throw a
          ? new Error("Can't find ".concat(i, " inside ").concat(a))
